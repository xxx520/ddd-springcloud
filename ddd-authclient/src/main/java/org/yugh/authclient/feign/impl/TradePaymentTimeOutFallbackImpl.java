 ...
 */
@Deprecated
@Component("tradePaymentTimeOutFallbackImpl")
public class TradePaymentTimeOutFallbackImpl implements TradePaymentService {
    ...
    return ResultUtils.fail(org.apache.http.HttpStatus.SC_INTERNAL_SERVER_ERROR, "进入超时熔断");
    }
